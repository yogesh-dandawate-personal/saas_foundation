# Epic: 36 — Notifications and Alert Intelligence

**Project:** i-Source One (ISO)  
**Epic Key:** ISO-36  
**Priority:** P3  
**Domain:** F — User Work and Command Centres  
**Status:** To Do
...
**Epic Scope:** Complete implementation of Notifications and Alert Intelligence module following SPARC methodology
...
- `ISO-36-CONTRACT` → blocks `ISO-36-BE` and `ISO-36-FE`
- `ISO-36-DATA` → blocks `ISO-36-BE`
- `ISO-36-BE` → blocks `ISO-36-QA`
- `ISO-36-FE` → blocks `ISO-36-QA`
- `ISO-36-QA` → blocks `ISO-36-OPS`
- `ISO-36-OPS` → blocks Epic completion
...
**Stories:** ISO-36-DATA, ISO-36-BE, ISO-36-FE
...
**Stories:** ISO-36-FE, ISO-36-BE, ISO-36-QA
...
- **Module Specification:** `/01_docs/Modules/36_*.md`
