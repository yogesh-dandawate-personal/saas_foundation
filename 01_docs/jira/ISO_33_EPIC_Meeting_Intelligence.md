...
**Epic Scope:** Complete implementation of Meeting Intelligence module following SPARC methodology
...
- `ISO-33-CONTRACT` → blocks `ISO-33-BE` and `ISO-33-FE`
- `ISO-33-DATA` → blocks `ISO-33-BE`
- `ISO-33-BE` → blocks `ISO-33-QA`
- `ISO-33-FE` → blocks `ISO-33-QA`
- `ISO-33-QA` → blocks `ISO-33-OPS`
- `ISO-33-OPS` → blocks Epic completion
...
**Stories:** ISO-33-DATA, ISO-33-BE, ISO-33-FE
...
**Stories:** ISO-33-FE, ISO-33-BE, ISO-33-QA
...
- **Module Specification:** `/01_docs/Modules/33_*.md`
