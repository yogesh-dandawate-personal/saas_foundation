# Epic: 05 — Roles, Personas and Groups
...
**Epic Scope:** Complete implementation of Roles, Personas and Groups module following SPARC methodology
...
- `ISO-05-CONTRACT` → blocks `ISO-05-BE` and `ISO-05-FE`
- `ISO-05-DATA` → blocks `ISO-05-BE`
- `ISO-05-BE` → blocks `ISO-05-QA`
- `ISO-05-FE` → blocks `ISO-05-QA`
- `ISO-05-QA` → blocks `ISO-05-OPS`
- `ISO-05-OPS` → blocks Epic completion
...
**Stories:** ISO-05-DATA, ISO-05-BE, ISO-05-FE
...
**Stories:** ISO-05-FE, ISO-05-BE, ISO-05-QA
...
- **Module Specification:** `/01_docs/Modules/05_*.md`
