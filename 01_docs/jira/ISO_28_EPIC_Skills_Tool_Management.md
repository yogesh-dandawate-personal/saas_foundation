# Epic: 28 — Skills and Tool Management
...
**Epic Scope:** Complete implementation of Skills and Tool Management module following SPARC methodology
...
- `ISO-28-CONTRACT` → blocks `ISO-28-BE` and `ISO-28-FE`
- `ISO-28-DATA` → blocks `ISO-28-BE`
- `ISO-28-BE` → blocks `ISO-28-QA`
- `ISO-28-FE` → blocks `ISO-28-QA`
- `ISO-28-QA` → blocks `ISO-28-OPS`
- `ISO-28-OPS` → blocks Epic completion
...
**Stories:** ISO-28-DATA, ISO-28-BE, ISO-28-FE
...
**Stories:** ISO-28-FE, ISO-28-BE, ISO-28-QA
...
- **Module Specification:** `/01_docs/Modules/28_*.md`
