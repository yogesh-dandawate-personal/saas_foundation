# Epic: 18 — Master and Reference Data
...
**Epic Scope:** Complete implementation of Master and Reference Data module following SPARC methodology
...
- `ISO-18-CONTRACT` → blocks `ISO-18-BE` and `ISO-18-FE`
- `ISO-18-DATA` → blocks `ISO-18-BE`
- `ISO-18-BE` → blocks `ISO-18-QA`
- `ISO-18-FE` → blocks `ISO-18-QA`
- `ISO-18-QA` → blocks `ISO-18-OPS`
- `ISO-18-OPS` → blocks Epic completion
...
**Stories:** ISO-18-DATA, ISO-18-BE, ISO-18-FE
...
**Stories:** ISO-18-FE, ISO-18-BE, ISO-18-QA
...
- **Module Specification:** `/01_docs/Modules/18_*.md`
