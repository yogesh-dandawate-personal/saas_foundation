# Epic: 35 — Project and Portfolio Management
...
**Epic Scope:** Complete implementation of Project and Portfolio Management module following SPARC methodology
...
- `ISO-35-CONTRACT` → blocks `ISO-35-BE` and `ISO-35-FE`
- `ISO-35-DATA` → blocks `ISO-35-BE`
- `ISO-35-BE` → blocks `ISO-35-QA`
- `ISO-35-FE` → blocks `ISO-35-QA`
- `ISO-35-QA` → blocks `ISO-35-OPS`
- `ISO-35-OPS` → blocks Epic completion
...
**Stories:** ISO-35-DATA, ISO-35-BE, ISO-35-FE
...
**Stories:** ISO-35-FE, ISO-35-BE, ISO-35-QA
...
- **Module Specification:** `/01_docs/Modules/35_*.md`
