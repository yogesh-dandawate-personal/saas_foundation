...
**Epic Scope:** Complete implementation of Data Catalogue module following SPARC methodology
...
- `ISO-15-CONTRACT` → blocks `ISO-15-BE` and `ISO-15-FE`
- `ISO-15-DATA` → blocks `ISO-15-BE`
- `ISO-15-BE` → blocks `ISO-15-QA`
- `ISO-15-FE` → blocks `ISO-15-QA`
- `ISO-15-QA` → blocks `ISO-15-OPS`
- `ISO-15-OPS` → blocks Epic completion
...
**Stories:** ISO-15-DATA, ISO-15-BE, ISO-15-FE
...
**Stories:** ISO-15-FE, ISO-15-BE, ISO-15-QA
...
- **Module Specification:** `/01_docs/Modules/15_*.md`
