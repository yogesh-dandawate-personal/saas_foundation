# Epic: 06 — Application Management
...
**Epic Scope:** Complete implementation of Application Management module following SPARC methodology
...
- `ISO-06-CONTRACT` → blocks `ISO-06-BE` and `ISO-06-FE`
- `ISO-06-DATA` → blocks `ISO-06-BE`
- `ISO-06-BE` → blocks `ISO-06-QA`
- `ISO-06-FE` → blocks `ISO-06-QA`
- `ISO-06-QA` → blocks `ISO-06-OPS`
- `ISO-06-OPS` → blocks Epic completion
...
**Stories:** ISO-06-DATA, ISO-06-BE, ISO-06-FE
...
**Stories:** ISO-06-FE, ISO-06-BE, ISO-06-QA
...
- **Module Specification:** `/01_docs/Modules/06_*.md`
